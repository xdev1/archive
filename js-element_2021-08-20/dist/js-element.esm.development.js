...
export { Attr, attr, createCtx, createEvent, createRef, defineProvider, event, intercept, prop, ref } from 'js-element/core';
...
const { createComponentType, createCustomElementClass, registerElement } = adapt.prototype.toString.__getHiddenAPI();
const { define, render, impl } = adapt({
...
export { asComponent, define, h, html, impl, render };
